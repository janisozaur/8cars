...
CONTROLBOXDATA
TextBox = { IDC_TEXT, NULL }, PromptBox = { IDC_PROMPT, NULL };
...
int * TextInputBox(HINSTANCE instance, HWND window, char * retBuff, char * prompt, char * baseString, int argMaxLength)
{
    int retv;
    ...
    retv = DialogBox(instance, MAKEINTRESOURCE(IDD_TEXTDIALOG), window, &GetTextDlgProc);
